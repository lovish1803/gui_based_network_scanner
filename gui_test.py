...
my_button = Button(second_frame, text="Aggressive Scan", command=submit1)
my_button.pack(pady=20)

my_button1 = Button(second_frame, text="Deep Scan", command=submit2)
my_button1.pack(pady=20)

my_button1 = Button(second_frame, text="Port Scan", command=submit3)
my_button1.pack(pady=20)
